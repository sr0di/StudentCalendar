...
class ProfilAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'universitate', 'facultate', 'specializare', 'limba_predare', 'an', 'grupa']
...
class AnAdmin(admin.ModelAdmin):
    list_display = ['id', 'denr', 'limba_predare']


class LimbaPredareAdmin(admin.ModelAdmin):
    list_display = ['id', 'denr', 'specializare']


class GrupaAdmin(admin.ModelAdmin):
    list_display = ['id', 'denr', 'an']
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('email', 'password', 'nume', 'prenume', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('id', 'email', 'nume', 'prenume', 'is_admin')
    list_filter = ('is_admin',)
    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        ('Personal info', {'fields': ('nume', 'prenume',)}),
...
admin.site.register(LimbaPredare, LimbaPredareAdmin)
